...
<br><br>
 ...
 <hr>
  ...
  <form  method="POST" enctype="multipart/form-data">
    ...
    <label class="adv_data" for="adv_con">وسيلة الإتصال:</label>
    <input type="text" id="adv_con" name="adv_con" placeholder="رقم الجوال او البريد الإلكتروني">
 ...
 while ($rows=mysqli_fetch_array($resu)) {
  echo '  <option value='.$rows['Category_ID'].'>'.$rows['Category_Name'].'</option>';
    ...
    <label class="adv_data" for="city">المنطق:</label>
